...
import {validateSenderName, validateSenderStreetAddress, validateSenderPinCode, validateSenderCity, validateCLientEmail, validateCLientName, validateClientCity, validateClientPinCode, validateClientStreetAddress, validateItemCount, validateItemName, validateItemPrice, validateSenderCountry, validateClientCountry } from '../functions/createInvoiceValidator'
...
function CreateInvoice({ openCreateInvoice, setOpenCreateInvoice, invoice, type }) {
    ...
    if (type === 'edit' && isFirstLoad) {
        ...
        setClientPinCode(invoice.clientAddress.pinCode)
        ...
        setSenderPinCode(invoice.senderAddress.pinCode)
    ...
    function validator() {
        if ( validateSenderName(senderName) && validateSenderStreetAddress(senderStreet) && validateSenderPinCode(senderPinCode) && validateSenderCity(senderCity) && validateCLientEmail(clientEmail) && validateCLientName(clientName) && validateClientCity(clientCity) && validateClientPinCode(clientPinCode) && validateClientStreetAddress(clientStreet) && validateSenderCountry(senderCountry) && validateClientCountry(clientCountry) && itemsValidator()) {
            return true
        }
        return false
    }
            ...
            >
                ...
                <div className=' overflow-y-scroll scrollbar-hide my-14'>
                    ...
                    <div className=' grid grid-cols-3 mx-1   space-y-4 '>
                        ...
                        <label className=' text-gray-400 font-light px-2'>
                                Sender Name
                            </label>
                            
                            <input type='text' value={senderName} onChange={(e) => setSenderName(e.target.value)} className={` dark:bg-[#1e2139] py-2 px-4 border-[.2px] rounded-lg  focus:outline-purple-400 border-gray-300 focus:outline-none ${isValidatorActive && !validateSenderName(senderName) && 'border-red-500 dark:border-red-500 outline-red-500 border-2'}   dark:border-gray-800`} />
                            </div>
                        ...
                        <div className=' flex flex-col mr-4 col-span-1'>
                            ...
                            <input type='text' value={senderPinCode} onChange={(e) => setSenderPinCode(e.target.value)} className={` dark:bg-[#1e2139] py-2 px-4 border-[.2px] rounded-lg focus:outline-none  focus:outline-purple-400 border-gray-300 ${isValidatorActive && !validateSenderPinCode(senderPinCode) && 'border-red-500 dark:border-red-500 outline-red-500 border-2'} dark:border-gray-800`} />
                        </div>
                    ...
                    <div className=' grid grid-cols-3 mx-1   space-y-4 '>
                        ...
                        <div className=' flex flex-col mr-4 col-span-1'>
                            ...
                            <input type='text' value={clientPinCode} onChange={(e) => setClientPinCode(e.target.value)}
                                className={` dark:bg-[#1e2139] py-2 px-4 border-[.2px] rounded-lg  focus:outline-purple-400 border-gray-300 focus:outline-none ${isValidatorActive && !validateClientPinCode(clientPinCode) && 'border-red-500 dark:border-red-500 outline-red-500 border-2'}   dark:border-gray-800`}
                            />
                        </div>
                        <div className=' flex flex-col col-span-1'>
                            <label className=' text-gray-400 font-light'>
