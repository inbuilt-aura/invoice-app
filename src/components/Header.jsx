...
function Header() {
  ...
  return (
    <div  >
      {/* Header */}
      <header className=' lg:hidden h-[75px] z-50  duration-300 ease-in-out  p-4  dark:bg-[#212454]  bg-[#590e9f] flex items-center justify-end   '>

        {/* Logo img */}

        <img src={logo} className='h-[75px] absolute top-0 left-0' alt="logo-image" />
        ...
        <div className='  flex  items-center  '>
          ...
          <div className=' h-[75px] border-dotted border-l border-[#494e6e] mx-6'>
