...
function Center() {
    ...
    return (
        <div>
            <div className='dark:bg-[#222648] scrollbar-hide duration-300 min-h-screen bg-[#d2d8db] py-[34px] px-2 md:px-8 lg:px-12 lg:py-[75px]  '>
                    ...
                    <div className=' min-w-full max-h-[64px] flex items-center justify-between'>
                        ...
                        <div className=' flex  max-h-full  items-center '>
                            ...
                            {isDropdown &&
                                ...
                                } className='  w-40 bg-white dark:bg-[#292f61] dark:text-white flex px-6 py-4 flex-col  top-[160px] lg:top-[120px]  absolute  shadow-3xl rounded-xl space-y-2    '>
                                    {filter.map((item, i) => (
                            ...
                            <button onClick={() => setOpenCreateInvoice(true)} className=' hover:opacity-80 ml-4 md:ml-10 flex items-center py-2 px-2 md:space-x-2 space-x-2 bg-[#4d45c5] rounded-xl'>
                                <img src={plus} alt="" className='h-[35px] rounded-full shadow-md bg-[#6ebce6]'/>
