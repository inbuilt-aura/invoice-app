    ...
    <div>
      {invoice ? (
        <motion.div
          ...
          className="dark:bg-[#141625] mx-auto duration-300 min-h-screen bg-[#cacacb] py-[34px] px-2 md:px-8 lg:px-12 max-w-3xl lg:py-[72px] "
        >
          <div className="">
            <button
              onClick={() => navigate(-1)}
            ...
            <div className=" mt-8 rounded-lg w-full flex items-center justify-between px-6 py-6 bg-white dark:bg-[#1e2139]">
              ...
              <div className=" md:block hidden">
                <button
                  ...
                  className=" text-[#6977c7] text-center dark:bg-[#242a5b] hover:opacity-90  bg-slate-200 p-3 px-8 rounded-full "
                >
                  Edit
                </button>
                <button
            ...
            <div className=" mt-4 rounded-lg w-full  px-6 py-6 bg-white dark:bg-[#1e2139]">
              <div className=" flex flex-col md:flex-row items-start justify-between w-full ">
                <div>
                  <h1 className=" font-semibold dark:text-white text-xl">
                    <span className="text-[#6371bb]">#</span>
                    {invoice.id}
                  </h1>
                  <p className=" text-sm text-gray-500">{invoice.clientName}</p>
                </div>
                <div className=" mt-4 md:mt-0 text-left text-gray-800 text-sm md:text-right felx flex-col items-center">
                  <p>{invoice.senderAddress.street}</p>
                  <p>{invoice.senderAddress.city}</p>,
                  <p>{invoice.senderAddress.pinCode}</p>
              ...
              <div className=" mt-10 grid grid-cols-2 w-full  md:grid-cols-3">
                <div className=" flex flex-col justify-between">
                  <div>
                    <h3 className=" text-gray-500 font-thin ">Invoice Date</h3>
                    <h1 className=" text-lg font-semibold dark:text-white">
                      {formatDate(invoice.createdAt)}
                    </h1>
                  </div>
                  <div>
                    <h3 className=" text-gray-500 font-thin ">Payment Due</h3>
                ...
                <div className="">
                  <p className=" text-gray-500 font-thin">Bill to</p>
                  <h1 className=" dark:text-white text-lg font-semibold">
                    {invoice.clientName}
                  </h1>
                ...
                <div className=" mt-8 md:mt-0">
                  <p className=" text-gray-500 font-thin">Sent to</p>
                  <h1 className=" dark:text-white text-lg font-semibold">
                    {invoice.clientEmail}
                  </h1>
                </div>
              ...
              <div className=" sm:hidden mt-10 bg-[#ececed] dark:bg-[#222647] rounded-lg rounded-b-none space-y-4  p-10">
              ...
              <div className=" hidden sm:block mt-10 bg-[#c8cbd6] dark:bg-[#2a2e48] rounded-lg rounded-b-none space-y-4  p-10">
                {invoice.items.map((item) => (
                  <div key={item.name} className=" flex justify-around  ">
                    <div className=" space-y-4">
                      <p className=" text-gray-500 font-thin">Item name</p>
                    ...
                    <div className=" space-y-4">
                      <p className=" text-gray-500 font-thin">Qty.</p>
                    ...
                    <div className=" space-y-4">
                      <p className=" text-gray-500 font-thin">Item price</p>
              ...
              <div className=" p-10 font-semibold text-white rounded-lg rounded-t-none justify-between flex dark:bg-[#7b3edc] bg-gray-600 ">
